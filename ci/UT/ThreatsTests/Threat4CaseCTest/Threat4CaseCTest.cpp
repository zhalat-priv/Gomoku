...
TEST(Threat4CaseCTest, FindPatternOnHorizontalTrendTest1)
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));

    // b:   .XX....
    m_pGomokuBoard->PutMove(Board::PositionXY(2, 3), Board::PLAYER_A);
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_A));

    // c:   .XX.X..
    m_pGomokuBoard->PutMove(Board::PositionXY(2, 5), Board::PLAYER_A);
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 5), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 5), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 6), ThreatFinder::HORIZONTAL, Board::PLAYER_A));

    // e:   OXX.XX.
    m_pGomokuBoard->PutMove(Board::PositionXY(2, 1), Board::PLAYER_B);
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 1), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 7), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 5), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 6), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
}
...
TEST(Threat4CaseCTest, FindPatternOnHorizontalTrendTest2)
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 1), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 4), ThreatFinder::HORIZONTAL, Board::PLAYER_A));

    m_pGomokuBoard->PutMove(Board::PositionXY(0, 0), Board::PLAYER_B);
    m_pGomokuBoard->PutMove(Board::PositionXY(0, 6), Board::PLAYER_B);
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 0), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 6), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 1), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 4), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 4), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 5), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 5), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
}
...
TEST(Threat4CaseCTest, FindPatternAbuttedToBoardFrameTest1)
{
    ...
    m_pGomokuBoard->PutMove(Board::PositionXY(0, 3), Board::PLAYER_A);
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 0), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 1), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 2), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 3), ThreatFinder::RISING, Board::PLAYER_A));
    ...
    m_pGomokuBoard->PutMove(Board::PositionXY(0, 4), Board::PLAYER_A);
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 1), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 2), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 4), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 0), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 4), ThreatFinder::RISING, Board::PLAYER_A));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(14, 10), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(13, 11), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 12), ThreatFinder::RISING, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 13), ThreatFinder::RISING, Board::PLAYER_A));
}
...
TEST(Threat4CaseCTest, FindPatternAbuttedToBoardFrameTest2)
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 11), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 12), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 13), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 14), ThreatFinder::FALLING, Board::PLAYER_B));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 11), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 12), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 13), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 14), ThreatFinder::FALLING, Board::PLAYER_B));
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(10, 0), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(10, 1), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(10, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(10, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 4), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 0), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 1), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    ...
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 1), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        true, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 4), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 5), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
}
...
TEST(Threat4CaseCTest, FindPatternAbuttedToBoardFrameTest3)
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 11), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 12), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(13, 13), ThreatFinder::FALLING, Board::PLAYER_B));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(14, 14), ThreatFinder::FALLING, Board::PLAYER_B));
}
...
TEST(Threat4CaseCTest, CheckingAgainstSixInRowTest1)
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 2), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 3), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 4), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 6), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CPPUNIT_ASSERT_EQUAL(
        false, m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 7), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
}
