...
TEST(Threat4CaseBTest, FindThreatFourPatternAbuttedToBoardFrame2Test)
{
    ...
    m_pGomokuBoard->PutMove(Board::PositionXY(3, 3), Board::PLAYER_A);
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 0), ThreatFinder::FALLING, Board::PLAYER_A));  // begin
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 2), ThreatFinder::FALLING, Board::PLAYER_A));  // middle
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 3), ThreatFinder::FALLING,
    ...
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 11), ThreatFinder::FALLING,
                                                  Board::PLAYER_A));  // begin
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 12), ThreatFinder::FALLING,
                                                  Board::PLAYER_A));  // middle
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(14, 14), ThreatFinder::FALLING,
                                                  Board::PLAYER_A));  // before end
}
...
TEST(Threat4CaseBTest, FindThreatFourPatternAbuttedToBoardFrame3Test)
{
    ...
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 14), ThreatFinder::RISING, Board::PLAYER_A));  // begin
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 13), ThreatFinder::RISING, Board::PLAYER_A));  // middle
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 11), ThreatFinder::RISING,
                                                  Board::PLAYER_A));  // before end
    ...
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(14, 0), ThreatFinder::RISING, Board::PLAYER_A));  // begin
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(13, 1), ThreatFinder::RISING, Board::PLAYER_A));  // middle
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 3), ThreatFinder::RISING,
                                                  Board::PLAYER_A));  // before end
}
...
TEST(Threat4CaseBTest, FindThreatFourPatternAbuttedToBoardFrame4Test)
{
    ...
    m_pGomokuBoard->PutMove(Board::PositionXY(5, 9), Board::PLAYER_B);
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 13), ThreatFinder::RISING, Board::PLAYER_A));  // begin
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(3, 11), ThreatFinder::RISING, Board::PLAYER_A));  // middle
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 10), ThreatFinder::RISING,
                                                  Board::PLAYER_A));  // before end
    ...
    m_pGomokuBoard->PutMove(Board::PositionXY(9, 5), Board::PLAYER_B);
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(13, 1), ThreatFinder::RISING, Board::PLAYER_A));  // begin
    CHECK_TRUE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 3), ThreatFinder::RISING, Board::PLAYER_A));  // middle
    CHECK_TRUE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(10, 4), ThreatFinder::RISING,
                                                  Board::PLAYER_A));  // before end
}
...
TEST(Threat4CaseBTest, FindThreatFourPatternAbuttedToBoardFrame5Test)
{
    ...
    m_pGomokuBoard->PutMove(Board::PositionXY(13, 13), Board::PLAYER_A);
    m_pGomokuBoard->PutMove(Board::PositionXY(14, 14), Board::PLAYER_A);
    CHECK_FALSE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(11, 11), ThreatFinder::FALLING,
                                                   Board::PLAYER_A));  // begin
    CHECK_FALSE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(12, 12), ThreatFinder::FALLING,
                                                   Board::PLAYER_A));  // middle
    CHECK_FALSE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(14, 14), ThreatFinder::FALLING,
                                                   Board::PLAYER_A));  // before end
    ...
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(2, 2), ThreatFinder::FALLING, Board::PLAYER_A));  // middle
    CHECK_FALSE(m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 4), ThreatFinder::FALLING,
                                                   Board::PLAYER_A));  // before end
}
...
TEST(Threat4CaseBTest, FindThreatSixInRowTest1)
{
    ...
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(0, 10), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
}
...
#warning "TODO: 6 pawns in row are improperly handled. This probably should be recognized by PostConditionConstrain()."
    // CHECK_FALSE( m_pThreatFinder->FindThreatPattern( Board::PositionXY( 6, 2 ), ThreatFinder::VERTICAL,
    // Board::PLAYER_A ) );
