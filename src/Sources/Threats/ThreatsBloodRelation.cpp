...
// Four threat group.
const ThreatFinder::KindOfThreats ThreatsBloodRelation::FOUR_LIST[] = {
    ThreatFinder::THREAT_4_CASE_A, ThreatFinder::THREAT_4_CASE_AA, ThreatFinder::THREAT_4_CASE_B,
    ThreatFinder::THREAT_4_CASE_C};
// Three threat group.
const ThreatFinder::KindOfThreats ThreatsBloodRelation::THREE_LIST[] = {
    ThreatFinder::THREAT_3_CASE_A, ThreatFinder::THREAT_3_CASE_AA, ThreatFinder::THREAT_3_CASE_B,
    ThreatFinder::THREAT_3_CASE_C};
// Two threat group.
const ThreatFinder::KindOfThreats ThreatsBloodRelation::TWO_LIST[] = {
    ThreatFinder::THREAT_2_CASE_A, ThreatFinder::THREAT_2_CASE_AA, ThreatFinder::THREAT_2_CASE_B,
    ThreatFinder::THREAT_2_CASE_C};
// Joker threats list.
const ThreatFinder::KindOfThreats ThreatsBloodRelation::JOKER_LIST[] = {
    ThreatFinder::THREAT_4_CASE_A, ThreatFinder::THREAT_4_CASE_B, ThreatFinder::THREAT_4_CASE_C};
// Ace threat list.
...
const ThreatFinder::KindOfThreats ThreatsBloodRelation::MANY_GAPS[] = {
    ThreatFinder::THREAT_3_CASE_A, ThreatFinder::THREAT_3_CASE_B, ThreatFinder::THREAT_2_CASE_A};
...
ThreatsBloodRelation::ThreatChanging ThreatsBloodRelation::DISMISSAL[] = {
    ...
    {ThreatChanging(ThreatFinder::THREAT_WINNER)},    {ThreatChanging(ThreatFinder::THREAT_4_CASE_A)},
    {ThreatChanging(ThreatFinder::THREAT_4_CASE_AA)}, {ThreatChanging(ThreatFinder::THREAT_4_CASE_B)},
    {ThreatChanging(ThreatFinder::THREAT_4_CASE_C)},  {ThreatChanging(ThreatFinder::THREAT_3_CASE_A)},
    {ThreatChanging(ThreatFinder::THREAT_3_CASE_AA)}, {ThreatChanging(ThreatFinder::THREAT_3_CASE_B)},
    {ThreatChanging(ThreatFinder::THREAT_3_CASE_C)},  {ThreatChanging(ThreatFinder::THREAT_2_CASE_A)},
    {ThreatChanging(ThreatFinder::THREAT_2_CASE_AA)}, {ThreatChanging(ThreatFinder::THREAT_2_CASE_B)},
