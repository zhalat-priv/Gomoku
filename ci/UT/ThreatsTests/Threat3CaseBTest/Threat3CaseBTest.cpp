...
TEST(Threat3CaseBTest, FindPatternSixInRowTest1)
{
    ...
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 10), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 12), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 13), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(4, 14), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    ...
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(6, 12), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(6, 13), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(6, 14), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
