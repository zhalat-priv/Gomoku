...
//	m_pBoardScoreHuman->AddThreats( threatContainer, ThreatFinder::THREAT_4_CASE_B );
//
//	CHECK_TRUE( numberOfThreatsTHREAT_2_CASE_C == m_pBoardScoreHuman->GetNumberOfRecognizedThreat(ThreatFinder::THREAT_2_CASE_C) );
//	CHECK_TRUE( numberOfThreatsTHREAT_3_CASE_A == m_pBoardScoreHuman->GetNumberOfRecognizedThreat(ThreatFinder::THREAT_3_CASE_A) );
//	CHECK_TRUE( numberOfThreatsTHREAT_4_CASE_B == m_pBoardScoreHuman->GetNumberOfRecognizedThreat(ThreatFinder::THREAT_4_CASE_B) );
//}
//
...
//	}
//
//	CHECK_TRUE( expectResult == m_pBoardScoreHuman->GetCommonFieldNumber( ThreatFinder::THREAT_2_CASE_A, ThreatFinder::THREAT_2_CASE_A ) );
//}
//
