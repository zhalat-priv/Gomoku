...
TEST(Threat2CaseATest, FindPatternSixInARow1)
{
    ...
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 12), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
    CHECK_FALSE(
        m_pThreatFinder->FindThreatPattern(Board::PositionXY(1, 13), ThreatFinder::HORIZONTAL, Board::PLAYER_A));
}
