...
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView1, Board::RIGHT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView1, Board::UP_RIGHT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( 0 ), m_GomokuBoard->NeighbourDistance( pointOfView1, Board::UP_LEFT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView1, Board::DOWN_RIGHT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView1, Board::DOWN_LEFT, Board::PLAYER_A ) );
//
...
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView2, Board::RIGHT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView2, Board::UP_RIGHT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView2, Board::UP_LEFT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( -2 ), m_GomokuBoard->NeighbourDistance( pointOfView2, Board::DOWN_RIGHT, Board::PLAYER_A ) );
//	LONGS_EQUAL( static_cast< int32_t >( 3 ), m_GomokuBoard->NeighbourDistance( pointOfView2, Board::DOWN_LEFT, Board::PLAYER_A ) );
//}
//
